### "[create_mach_files.sh](./create_mach_files.sh)" - автоматизированное создание заданного (большого) числа файлов, состоящих из заданной символьной последовательности
