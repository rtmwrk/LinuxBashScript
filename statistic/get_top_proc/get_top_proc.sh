...
#-------------------------------------------------------------
# get_top_proc: скрипт  мониторинг топ-10  процессов, наиболее 
#               загружающих систему по параметрам CPU и Mem
#--------------------------------------------------------------
...
echo "-------------------------------------------------------------"
echo " get_top_proc: скрипт  мониторинг топ-10  процессов, наиболее"
echo "               загружающих систему по параметрам CPU и Mem"
echo "-------------------------------------------------------------"
